...
### Database Tuning
Smart Gnome Control's makes use of the Eibi shortwave schedules. Whereas the older Smart Control applications used six different windows to show information, Smart Gnome Control leverages the more modern Frequency Browser layout to provide a fully integrated display.
